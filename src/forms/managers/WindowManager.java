...
public class WindowManager {
	...
	public void close(Server server, Client client) {
		try {
			boolean serverStarted = server.isConnected();
			server.stop(); // We have to stop the server even if it's not connected ("extends UnicastRemoteObject" already starts it).
			if (serverStarted) System.out.println("Server stopped.");

	...
	private void initializeMenuBar() {
		...
		mntmStart.addActionListener(new ActionListener() {
		    public void actionPerformed(ActionEvent e) {
		    	...
		    	try {
		    		...
		    		helpText.setText("Error: Failed to start server. RemoteException occurred. Please try on another port.");
		    	} catch (MalformedURLException ex) {
		    		helpText.setText("Error: Failed to start server. MalformedURLException occurred.");
		    	}
		    }
		});
		...
		mntmConnect.addActionListener(new ActionListener() {
		    public void actionPerformed(ActionEvent e) {
		    	panel.repaint();
		    	try {
		    		String[] serverInfos = client.connectToServer();
			    	helpText.setText("Connected to server (ip:" + serverInfos[0] + ", port:" + serverInfos[1] + ").");
		    	} catch (RemoteException ex) {
		    		helpText.setText("Error: Failed to connect to server. RemoteException occurred.");
		    	} catch (MalformedURLException ex) {
		    		helpText.setText("Error: Failed to connect to server. MalformedURLException occurred.");
		    	}  catch (NotBoundException ex) {
		    		helpText.setText("Error: Failed to connect to server. NotBoundException occurred.");
		    	}
		    }
		});
